/**
 * Terrain gen matching js/World.js (perlin elevation / temperature / river).
...
(function (root, factory) {
    if (typeof module === "object" && module.exports) {
        ...
        module.exports = factory(rng, Structures, DataStore);
    } else {
        root.WorldGen = factory(root.NetRng, root.Structures, root.DataStore);
    }
})(typeof globalThis !== "undefined" ? globalThis : this, function (rng, Structures, DataStore) {
    ...
    function noiseApi() {
        ...
        if (typeof globalThis !== "undefined" && globalThis.noise) {
            _noise = globalThis.noise;
            return _noise;
        }
        if (typeof require === "function") {
            const loaded = require("../../js/noisejs-master/perlin.js");
            _noise = loaded && (loaded.noise || loaded);
            if (_noise && typeof _noise.perlin2 === "function") return _noise;
            if (typeof globalThis !== "undefined" && globalThis.noise) {
                _noise = globalThis.noise;
                return _noise;
            }
        }
        throw new Error("Failed to load perlin noise module");
    }
